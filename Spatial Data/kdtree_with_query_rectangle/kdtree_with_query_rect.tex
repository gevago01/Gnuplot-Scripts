...
\begingroup
  ...
  \begin{picture}(5040.00,3772.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \csname LTb\endcsname%
      \put(1509,2587){\makebox(0,0){\strut{}$r_1$}}%
      \put(2489,1053){\makebox(0,0){\strut{}$r_2$}}%
      \put(3664,1360){\makebox(0,0){\strut{}$r_3$}}%
      \put(4251,1360){\makebox(0,0){\strut{}$r_4$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{kdtree_with_query_rect}}%
    \gplfronttext
  \end{picture}%
\endgroup
