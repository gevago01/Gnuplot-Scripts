...
#set boxwidth 0.5
set xlabel "Dataset"
set ylabel "Percentage of futile searches"
#set grid
#set xtics 1
set ytics 0.2
set yrange[0:1.27]

plot "data.txt" u 2:xtic(1) t "R*-Tree"  fill pattern 1,"" u 3:xtic(1) t "RR*-Tree"  fill pattern 2,"" u 4:xtic(1) t "HR-Tree"  fill pattern 3,"" u 5:xtic(1) t "QR-Tree"  fill pattern 4

set terminal postscript eps  enhanced  font 'Helvetica,20' linewidth 1
set output "futile_percentage.eps" # specify the output filename
