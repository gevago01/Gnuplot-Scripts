...
set key below
# set the title
set title "Building Overhead"
# Select histogram data
set style data histogram 
#set labels 
set xlabel "Datasets"
set ylabel "\% CPU instruction"
set yrange [0:1.1]
#set grid y

set style histogram rowstacked 
set boxwidth 0.6 relative
plot 'data.txt' index 0 u 2:xtic(1) t "Insert Record" fill pattern 1 , '' index 0 u 3 t 'Build Grid' fill pattern 2 #, '' index 0 u 4 t 'Level 3' fill pattern 3
set terminal postscript eps  enhanced  font 'Helvetica,20' linewidth 1
set output 'building_overhead.eps'
